...
namespace APIVersioning.Controllers
{
    ...
    [ApiVersion("2.0")]
    [ApiVersion("3.0")]
    public class TodoTestController : Controller
    {
        private static List<TodoDTO> TodoData = null;

        private readonly ILogger<TodoTestController> _logger;

        public TodoTestController(ILogger<TodoTestController> logger, IConfiguration _configuration)
        {
            _logger = logger;
